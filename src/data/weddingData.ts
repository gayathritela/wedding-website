...
export const venueConfig = {
  ...
  hotels: [
    { name: "Hotel Ramyas",   website: "https://www.hotelramyas.com", stars: 4 },
    { name: "Hotel Shaans",   website: "https://www.hotelshaans.com", stars: 4 },
    { name: "Marriott Hotel",  website: "https://www.marriott.com",    stars: 5 },
...
export const weddingEvents: WeddingEvent[] = [
  {
    ...
    location: "Trichy",
    description:
      "Turmeric, flowers, laughter, and full yellow chaos. No one is leaving spotless!",
    theme: "Haldi & Happy Chaos",
    icon: "🌼",
  ...
  },
  {
    ...
    location: "Trichy",
    description:
      "Henna, music, snacks, gossip, and chill pre-wedding fun at home in Trichy. Come sit, laugh, and get your hands done!",
    theme: "Henna & Chill",
    icon: "🌿",
    mapUrl: "https://maps.google.com/?q=Trichy+Tiruchirappalli",
    livestreamUrl: "",
  ...
  },
  {
    ...
    description:
      "Rings, dance, music, and full fun. No language rules, no shy faces, just every beat and every vibe. Bring your dance moves, singing skills, or show us the talent you have been hiding. Let's have fun!",
    theme: "Rings & Dance Drama",
    icon: "💍",
    mapUrl: venueConfig.googleMapsUrl,
    livestreamUrl: "",
    accentColor: "bg-pink-500",
    textColor: "text-pink-700",
    dressCode: "Pink & Purple",
  },
  {
    id: "wedding",
    ...
    location: "The Royal Mahal,Trichy",
    description:
      "The big day! Come bless us and join us for the wedding muhurtham between 8:50 AM and 10:20 AM, with traditions, love, and happy tears.",
    theme: "The Big Day",
    icon: "🪔",
    mapUrl: venueConfig.googleMapsUrl,
    ...
    dressCode: "Traditional — Red, Gold & Cream",
  },
  {
    id: "reception",
    ...
    description:
      "One more celebration, this time in Hyderabad. Come dressed up, take too many pictures, and let's eat to our hearts' content!",
    theme: "Food, Photos & Celebration",
    icon: "🌸",
    mapUrl: "https://maps.google.com/?q=Moksh+Banquets+Necklace+Road+Hyderabad",
    livestreamUrl: "",
    accentColor: "bg-amber-500",
    textColor: "text-amber-700",
    dressCode: "Formal Ethnic — Royal Blue & Silver",
  },
];
